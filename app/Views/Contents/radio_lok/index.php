                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php foreach ($radioLoks as $key => $radioLok) : ?>
                                <tr>
                                    <td><?= $key + 1 ?></td>
                                    ...
                                    <td>
                                        ...
                                        <button role="button" class="btn btn-primary mr-2 mb-2" disabled>
                                            ...
                                            Approved!</button>
                                        <?php else:?>
                                        <?= form_open(url_to('radio_lok.update'), ['id' => 'approveRadioLok']) ?>
                                        <a role="button" class="btn btn-success mr-2 mb-2"
                                            onclick="document.getElementById('approveRadioLok').submit()">
                                            <i class="fas fa-check"></i>
                                            Approve
                                            <input type="hidden" value="<?= $radioLok->id ?>" name="id">
