...
<head>
  ...
  <title>SISRALOK | Dashboard</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link" href="<?= url_to('') ?>" role="button">
        <i class="fas fa-door-open"></i>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-controlsidebar-slide="true" href="<?= base_url('#') ?>" role="button">
