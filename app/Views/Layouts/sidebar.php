            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        ...
                        <a href="<?= base_url('#') ?>" class="d-block"><?= session('data')['username'] ?></a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('pages/layout/fixed-sidebar-custom.html') ?>"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="<?= base_url('pages/examples/register.html') ?>"
                                                class="nav-link">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>Register v1</p>
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a href="<?= base_url('pages/examples/forgot-password.html') ?>"
                                                class="nav-link">
                                                <i class="far fa-circle nav-icon"></i>
                                        ...
                                        <li class="nav-item">
                                            <a href="<?= base_url('pages/examples/recover-password.html') ?>"
                                                class="nav-link">
                                                <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="<?= base_url('pages/examples/login-v2.html') ?>"
                                                class="nav-link">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>Login v2</p>
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a href="<?= base_url('pages/examples/register-v2.html') ?>"
                                                class="nav-link">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>Register v2</p>
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a href="<?= base_url('pages/examples/forgot-password-v2.html') ?>"
                                                class="nav-link">
                                                <i class="far fa-circle nav-icon"></i>
                                        ...
                                        <li class="nav-item">
                                            <a href="<?= base_url('pages/examples/recover-password-v2.html') ?>"
                                                class="nav-link">
                                                <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('pages/examples/legacy-user-menu.html') ?>"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
